...
export async function GET(request) {
  ...
  const apiUrl = `https://barikoi.xyz/v2/api/search/reverse/geocode?api_key=bkoi_d41c8ce598cb4c2dbdaa67d34bcfd2f9e06e90a2c10620fddb7f2ff280ffe939&longitude=${longitude}&latitude=${latitude}&district=true&post_code=true&country=true&sub_district=true&union=true&pauroshova=true&location_type=true&division=true&address=true&area=true`;
